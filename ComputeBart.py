...
class ComputeBart(object):
    def __init__(self, pb=0.5, alpha=0.95, beta=2.0, nd=1000, lambda_=1.0, burn=100, m=200, nc=100, nu=3.0, kfac=2.0):
    ...
    def fit_and_predict(self, X, y, X1):
        ...
        self.bart_regressor.set_insample_matrix(X)
        self.bart_regressor.set_insample_target(y)
        self.bart_regressor.set_outsample_matrix(X1)
